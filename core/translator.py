            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "   - For common or basic expressions that can have multiple translations (like 'así'), provide 3-4 diverse translations separated by slashes (e.g., 'así' -> '이렇게 / 이대로 / 그대로 / 그렇게').\n"
